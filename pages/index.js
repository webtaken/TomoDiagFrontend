      ...
      <LayoutPage>
        <div className="site-layout-content">
          <div className={styles.home}>
            ...
            <div>
              <p>
                La clínica San Pablo ofrece una gran variedad de programas de
                asistencia médica, con el respaldo del Ministerio de Salud. De
                esta manera usted y su familia pueden acceder a los mejores
                servicios de salud brindados por profesionales altamente
                ...
                acomode a sus requerimientos y acudir para su atención a la
                clinica de San Pablo de su preferencia.
              </p>
            </div>
          </div>
          {user && <AppOptions />}
